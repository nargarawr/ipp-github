...
{
    /**
     * @ Implement Analyzer substitution
     * @ Implement Zend_Search_Lucene_Storage_DirectoryRAM and Zend_Search_Lucene_Storage_FileRAM to use it for
     *       temporary index files
     * @ Directory lock processing
     */
        ...
        if (Zend_Search_Lucene_LockManager::escalateReadLock($this->_directory)) {
            ...
            foreach ($filesToDelete as $file) {
                try {
                    ...
                    /** @ Process '.cfx' files to check if them are already unused */
