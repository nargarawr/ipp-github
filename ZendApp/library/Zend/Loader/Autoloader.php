...
class Zend_Loader_Autoloader
{
    ...
    public static function autoload($class)
    {
        ...
        /*
            Hack to let me rename all my models to not have Application_Model_ at the start
            Craig Knott, 27/05/2015
        */
        $dir = APPLICATION_PATH . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR;
        $models = scandir($dir);
        if (in_array($class . '.php', $models)) {
            $class = 'Application_Model_' . $class;
        }
