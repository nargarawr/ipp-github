...
class Zend_Soap_Wsdl
{
    ...
    public function __construct($name, $uri, $strategy = true)
    {
        ...
        /**
         * @ change DomDocument object creation from cparsing to construxting using API
    ...
    public function setUri($uri)
    {
        ...
        if($this->_dom !== null) {
            // @: This is the worst hack ever, but its needed due to design and non BC issues of WSDL generation
