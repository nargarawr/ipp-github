...
{
    // : with an internal cache we could optimize this class, or create an extra class with
    ...
    {
        // : use search to find number directly
    ...
    {
        // : we assume / as the hierarchy delim - need to get that from the folder class!
    ...
    public function appendMessage($message, $folder = null, $flags = null)
    {
        ...
        // : handle class instances for $message
