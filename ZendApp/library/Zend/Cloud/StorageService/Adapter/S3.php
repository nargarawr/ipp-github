    ...
    implements Zend_Cloud_StorageService_Adapter
{
    ...
    {
        try {
            //  We *really* need to add support for object copying in the S3 adapter
    ...
    {
        try {
            //  Support 'prefix' parameter for Zend_Service_Amazon_S3::getObjectsByBucket()
